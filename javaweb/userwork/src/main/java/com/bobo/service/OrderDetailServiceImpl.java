...
public class OrderDetailServiceImpl implements OrderDetailService {
  ...
  public List<OrderDetail> selectPage(int begin, int pageSize, String order_no) {
    ...
    return orderDetailDao.queryMulti(sql, OrderDetail.class, order_no, begin, pageSize);
  }

	@Override
	public long selectCountByGoodNo(String good_no) {
		String sql = "SELECT count(*) as total FROM order_detail where good_no = ?";
    return (Long) orderDetailDao.queryScalar(sql, good_no);
	}
    ...
    return orderDetailDao.queryMulti(sql, OrderDetailVO.class, good_no, begin, pageSize);
	}
