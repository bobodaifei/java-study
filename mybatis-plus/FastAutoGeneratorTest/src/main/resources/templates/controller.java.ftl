...
public Result<?> add${entity}(@Valid @RequestBody ${entity}DTO dto) {
    ...
    public Result<?> modify${entity}(@PathVariable Long id, @Valid @RequestBody ${entity}DTO dto) {
        service.modify${entity}(id, dto);
        return Result.success();
        }
        ...
        public Result<?> delete${entity}(@PathVariable Long id) {
            ...
            public Result<?> query${entity}ById(@PathVariable Long id) {
                ...
                public Result<?> pagingList(@Valid @RequestBody ${entity}Query query) {
