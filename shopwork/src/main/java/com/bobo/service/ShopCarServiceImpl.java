...
public class ShopCarServiceImpl implements ShopCarService{
  ...
  public long selectCount() {
    String sql = "SELECT count(*) as total FROM shop_car";
    return (Long) shopCarDao.queryScalar(sql);
  }
  ...
  @Override
  public List<ShopCarVO> selectPage(int begin, int pageSize) {
    ...
    return shopCarDao.queryMulti(sql, ShopCarVO.class, begin, pageSize);
  }
