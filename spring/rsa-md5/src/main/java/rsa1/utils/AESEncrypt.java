...
//    https://www.cnblogs.com/linghu-java/p/8745416.html
    private String key;
    ...
    public static void main(String[] args) throws Exception {
        byte[] kkies = AESEncrypt.aesEncryptToBytes("123456", "kky");
        System.out.println(HexUtil.bytes2Hex(kkies));
        System.out.println(AESEncrypt.base64Encode(kkies));
        String kky = AESEncrypt.aesDecryptByBytes(kkies, "kky");
