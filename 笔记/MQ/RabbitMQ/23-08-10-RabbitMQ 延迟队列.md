...
![1691658358104](image/23-08-10-RabbitMQ延迟队列/1691658358104.png)

## [#](https://frxcat.fun/middleware/RabbitMQ/RabbitMQ_Delay_queue/#ttl%E7%9A%84%E4%B8%A4%E7%A7%8D%E8%AE%BE%E7%BD%AE)TTL的两种设置
...
## [#](https://frxcat.fun/middleware/RabbitMQ/RabbitMQ_Delay_queue/#%E6%95%B4%E5%90%88springboot)整合SpringBoot
...
## [#](https://frxcat.fun/middleware/RabbitMQ/RabbitMQ_Delay_queue/#%E9%98%9F%E5%88%97ttl)队列TTL

### [#](https://frxcat.fun/middleware/RabbitMQ/RabbitMQ_Delay_queue/#%E4%BB%A3%E7%A0%81%E6%9E%B6%E6%9E%84%E5%9B%BE)**代码架构图**

创建两个队列 QA 和 QB，两个队列的 TTL 分别设置为 10S 和 40S，然后再创建一个交换机 X 和死信交换机 Y，它们的类型都是 direct，创建一个死信队列 QD，它们的绑定关系如下：

![1691658367047](image/23-08-10-RabbitMQ延迟队列/1691658367047.png)

原先配置队列信息，写在了生产者和消费者代码中，现在可写在配置类中，生产者只发消息，消费者只接受消息

### [#](https://frxcat.fun/middleware/RabbitMQ/RabbitMQ_Delay_queue/#%E9%85%8D%E7%BD%AE%E7%B1%BB%E4%BB%A3%E7%A0%81)**配置类代码**
...
### [#](https://frxcat.fun/middleware/RabbitMQ/RabbitMQ_Delay_queue/#%E7%94%9F%E4%BA%A7%E8%80%85)生产者
...
发起一个请求：[http://localhost:8888/ttl/sendMsg/嘻嘻嘻(opens new window)](http://localhost:8888/ttl/sendMsg/%E5%98%BB%E5%98%BB%E5%98%BB)
...
## [#](https://frxcat.fun/middleware/RabbitMQ/RabbitMQ_Delay_queue/#%E5%BB%B6%E6%97%B6%E9%98%9F%E5%88%97ttl%E4%BC%98%E5%8C%96)延时队列TTL优化

在这里新增了一个队列 QC，该队列不设置 TTL 时间，根据前端的请求确定 TTL 时间，绑定关系如下：

![1691658376661](image/23-08-10-RabbitMQ延迟队列/1691658376661.png)

### [#](https://frxcat.fun/middleware/RabbitMQ/RabbitMQ_Delay_queue/#%E9%85%8D%E7%BD%AE%E7%B1%BB%E4%BB%A3%E7%A0%81-2)**配置类代码**
...
### [#](https://frxcat.fun/middleware/RabbitMQ/RabbitMQ_Delay_queue/#%E7%94%9F%E4%BA%A7%E8%80%85-2)生产者
...
[http://localhost:8888/ttl/sendExpirationMsg/你好1/20000](http://localhost:8888/ttl/sendExpirationMsg/你好1/20000)

[http://localhost:8888/ttl/sendExpirationMsg/你好2/2000](http://localhost:8888/ttl/sendExpirationMsg/你好1/2000)

> **出现问题** :
>
> ![1691658385335](image/23-08-10-RabbitMQ延迟队列/1691658385335.png)
...
## [#](https://frxcat.fun/middleware/RabbitMQ/RabbitMQ_Delay_queue/#rabbitmq%E6%8F%92%E4%BB%B6%E5%AE%9E%E7%8E%B0%E5%BB%B6%E8%BF%9F%E9%98%9F%E5%88%97)Rabbitmq插件实现延迟队列
...
打开 Linux，用 `Xftp` 将插件放到 RabbitMQ 的=安装目录=下的 plgins 目录，
...
![1691658392727](image/23-08-10-RabbitMQ延迟队列/1691658392727.png)

## [#](https://frxcat.fun/middleware/RabbitMQ/RabbitMQ_Delay_queue/#%E6%8F%92%E4%BB%B6%E5%AE%9E%E6%88%98)插件实战

在这里新增了一个队列 delayed.queue，一个自定义交换机 delayed.exchange，绑定关系如下:

![1691658397537](image/23-08-10-RabbitMQ延迟队列/1691658397537.png)

### [#](https://frxcat.fun/middleware/RabbitMQ/RabbitMQ_Delay_queue/#%E9%85%8D%E7%BD%AE%E7%B1%BB%E4%BB%A3%E7%A0%81-3)配置类代码
...
```
 ...
 [http://localhost:8888/ttl/sendDelayMsg/hello1/20000(opens new window)](http://localhost:8888/ttl/sendDelayMsg/hello1/20000)

[http://localhost:8888/ttl/sendDelayMsg/hello2/2000(opens new window)](http://localhost:8888/ttl/sendDelayMsg/hello2/2000)

![1691658407287](image/23-08-10-RabbitMQ延迟队列/1691658407287.png)

可以看到哪怕 hello1 需要20秒再进入延时队列，hello2 2 秒后直接进入延时队列，无需等待 hello1

![1691749598275](image/23-08-10-RabbitMQ延迟队列/1691749598275.png)

## [#](https://frxcat.fun/middleware/RabbitMQ/RabbitMQ_Delay_queue/#%E6%80%BB%E7%BB%93)总结
