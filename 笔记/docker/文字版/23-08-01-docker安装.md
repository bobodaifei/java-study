...
![1690867522141](image/23-08-01-docker安装/1690867522141.png)
...
## [#](https://frxcat.fun/project-management/Docker/Docker_install/#docker%E7%9A%84%E5%9F%BA%E6%9C%AC%E7%BB%84%E6%88%90)Docker的基本组成
 ...
 **最大的公开仓库是 DockerHub** ([https://hub.docker.com/ **(opens new window)**](https://hub.docker.com/))，存放了数量庞大的镜像供用户下载。国内的公开仓库包括阿里云 、网易云等
...
## [#](https://frxcat.fun/project-management/Docker/Docker_install/#docker%E5%B9%B3%E5%8F%B0%E6%9E%B6%E6%9E%84%E5%9B%BE%E8%A7%A3-%E5%85%A5%E9%97%A8%E7%89%88)Docker平台架构图解(入门版)

![1690869387617](image/23-08-01-docker安装/1690869387617.png)

## [#](https://frxcat.fun/project-management/Docker/Docker_install/#docker%E5%B9%B3%E5%8F%B0%E6%9E%B6%E6%9E%84%E5%9B%BE%E8%A7%A3-%E6%9E%B6%E6%9E%84%E7%89%88)Docker平台架构图解(架构版)
...
![1690867537311](image/23-08-01-docker安装/1690867537311.png)
...
![1690867544460](image/23-08-01-docker安装/1690867544460.png)

## [#](https://frxcat.fun/project-management/Docker/Docker_install/#%E6%93%8D%E4%BD%9C%E7%B3%BB%E7%BB%9F%E8%A6%81%E6%B1%82)操作系统要求

要安装 Docker 引擎，您需要 CentOS 7 或 8 的维护版本。不支持或测试存档版本，并且 Linux 版本 3.10.0+，包括 3.10.0。

该 `centos-extras` 库必须启用。默认情况下启用此存储库，但如果您已禁用它，则需要 [重新启用它 **(opens new window)**](https://wiki.centos.org/AdditionalResources/Repositories)。

`overlay2` 推荐使用存储驱动。

## [#](https://frxcat.fun/project-management/Docker/Docker_install/#%E5%8D%B8%E8%BD%BD%E6%97%A7%E7%89%88%E6%9C%AC)卸载旧版本
...
## [#](https://frxcat.fun/project-management/Docker/Docker_install/#%E5%AE%89%E8%A3%85%E6%96%B9%E6%B3%95)安装方法
...
![1690869452597](image/23-08-01-docker安装/1690869452597.png)
...
前往 [https://download.docker.com/linux/centos/ (opens new window) **(opens new window)**](https://download.docker.com/linux/centos/)并选择您的 CentOS 版本。然后浏览 `x86_64/stable/Packages/` 并下载 `.rpm` 要安装的 Docker 版本的文件。
...
Docker 在 [get.docker.com (opens new window) **(opens new window)**](https://get.docker.com/)上提供了一个方便的脚本，可以快速且非交互式地将 Docker 安装到开发环境中。不建议将便捷脚本用于生产环境，但可以用作示例来创建适合您需求的配置脚本。
...
此示例从 [get.docker.com (opens new window) **(opens new window)**](https://get.docker.com/)下载脚本并运行它以在 Linux 上安装 Docker 的最新稳定版本，另外可以通过 `--mirror` 选项使用国内下载源进行安装：
...
首先，我们需要更新软件源，使得 CentOS8 可以安装更多软件。
...
Docker 运行时需要一些工具和依赖库，而这些在 CentOS8 上并不够完整，需要进行安装。
...
在本步骤中，我们将下载并安装 Docker 的社区版软件。要避免在每次更新时都需要查看官方网站以获取 Docker 版本号，我们可以安装 docker-ce 软件源。

输入以下命令将 Docker 的软件源添加到 CentOS8 系统中：
...
步骤4：安装 Docker Engine 社区版

使用以下命令在 CentOS8 上安装 Docker Engine 社区版：
...
构建完 Docker 的环境后，我们需要设置 Docker 服务，使其在启动时自动启动。
...
最后，我们需要使用以下命令检查 Docker 版本是否正确安装：
...
![在这里插入图片描述](https://img-blog.csdnimg.cn/2b49766bf0714c568d6a6b8321cd06de.png?x-oss-process=image/watermark,type_d3F5LXplbmhlaQ,shadow_50,text_Q1NETiBA5qC85p6X5biM5bCU,size_20,color_FFFFFF,t_70,g_se,x_16)
...
![在这里插入图片描述](https://img-blog.csdnimg.cn/b6c415c60b8349efb32c8f58136d387e.png)
    安装最新版本的docker
...
![在这里插入图片描述](https://img-blog.csdnimg.cn/f96bde2385af4b0ab0a59c23b7a5803e.png?x-oss-process=image/watermark,type_d3F5LXplbmhlaQ,shadow_50,text_Q1NETiBA5qC85p6X5biM5bCU,size_20,color_FFFFFF,t_70,g_se,x_16)

```powershell
# 设置开机自启docker 并启动docker
...
![在这里插入图片描述](https://img-blog.csdnimg.cn/01b9670ae5324481aa001266586d67f5.png)
...
* 访问阿里云登录自己的账号查看 docker 镜像加速服务：[https://cr.console.aliyun.com/cn-shenzhen/instances/mirrors(opens new window)](https://cr.console.aliyun.com/cn-shenzhen/instances/mirrors)

![1690867561827](image/23-08-01-docker安装/1690867561827.png)
...
![1690867571417](image/23-08-01-docker安装/1690867571417.png)
...
![1690867576107](image/23-08-01-docker安装/1690867576107.png)
