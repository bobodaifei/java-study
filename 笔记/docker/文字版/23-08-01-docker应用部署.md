...
![1690891695881](image/23-08-01-docker应用部署/1690891695881.png)

### tomcat

![1690891717941](image/23-08-01-docker应用部署/1690891717941.png)
...
tomcat 版本网址：[https://registry.hub.docker.com/_/tomcat(opens new window)](https://registry.hub.docker.com/_/tomcat)
...
* 配置文件启动：创建配置文件的数据卷，在宿主机的挂载目录修改配置文件，就会同步到容器的配置文件中（重点）
...
MySQL 版本网址：[https://registry.hub.docker.com/_/mysql(opens new window)](https://registry.hub.docker.com/_/mysql)
...
* [无注解版(可用)](https://frxcat.fun/project-management/Docker/Docker_Software_installation/#%E6%97%A0%E6%B3%A8%E8%A7%A3%E7%89%88(%E5%8F%AF%E7%94%A8))
* [有注解版(只看不用)](https://frxcat.fun/project-management/Docker/Docker_Software_installation/#%E6%9C%89%E6%B3%A8%E8%A7%A3%E7%89%88(%E5%8F%AA%E7%9C%8B%E4%B8%8D%E7%94%A8))
...
docker run -id \
    ...
    -v /root/docker/mysql/log:/var/log \
    mysql:latest
```
...
Redis 版本网址：[https://registry.hub.docker.com/_/redis(opens new window)](https://registry.hub.docker.com/_/redis)
